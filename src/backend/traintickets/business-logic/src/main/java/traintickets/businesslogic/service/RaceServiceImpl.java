...
//
//    @Override
//    public void addRace(UUID sessionId, Race race) throws TrainAlreadyReservedException {
//        race.validate();
...
//
//    @Override
//    public Race getRace(UUID sessionId, RaceId raceId) {
...
//
//    @Override
//    public void finishRace(UUID sessionId, RaceId raceId) {
//        raceRepository.updateRace(sessionManager.getUserInfo(sessionId).role(), raceId, true);
//    }
//
//    @Override
//    public Map<String, List<String>> getPassengers(UUID sessionId, RaceId raceId) {
//        var role = sessionManager.getUserInfo(sessionId).role();
