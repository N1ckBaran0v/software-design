...
class RouteServiceImplTest {
    ...
    void getRoutes_positive_got() {
        ...
        given(raceRepository.getRaces(systemRole, filter)).willReturn(List.of(race1, race2, race3));
    ...
    void getFreePlaces_positive_got() {
        ...
        given(ticketRepository.getTicketsByRace(systemRole, raceId)).willReturn(List.of(ticket));
