...
class CommentServiceImplTest {
    ...
    void addComment_positive_saved() {
        ...
        var comment = new Comment(null, userId, new TrainId("737"), 5, "good");
    ...
    void addComment_negative_invalid() {
        var userId = new UserId("1");
        var comment = new Comment(null, userId, new TrainId("737"), 6, "good");
        assertThrows(InvalidEntityException.class, () -> commentService.addComment(userId, comment));
    ...
    void addComment_negative_userIdMismatched() {
        ...
        assertThrows(InvalidEntityException.class, () -> commentService.addComment(new UserId("2"), comment));
        verify(commentRepository, never()).addComment(any());
    }
