...
6. Покупатель нажимает кнопку "Купить".
- ### Добавление поездки
1. Гость заходит на сайт;
...
3. Администратор переходит на страницу поиска поездок;
4. Администратор выбирает поездку;
5. Администратор нажимает кнопку "Показать список пассажиров".
